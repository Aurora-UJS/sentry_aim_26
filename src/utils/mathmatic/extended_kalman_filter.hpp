#ifndef UTILS__EXTENDED_KALMAN_FILTER_HPP
#define UTILS__EXTENDED_KALMAN_FILTER_HPP
...
public:
  ...
  ExtendedKalmanFilter(
      ...
      std::function<Eigen::VectorXd(const Eigen::VectorXd &,
          ...
          x_add = [](const Eigen::VectorXd &a, const Eigen::VectorXd &b) {
            return a + b;
          });
  ...
  Eigen::VectorXd
  predict(const Eigen::MatrixXd &F, const Eigen::MatrixXd &Q,
...
#endif // UTILS__EXTENDED_KALMAN_FILTER_HPP