 ...
 *
 * This filter supports partial adaptation by blending the predicted process noise and measurement
 * noise with prior noise levels. It also handles nonlinear measurement and process models via Ceres
 * Jet auto-differentiation.
 *
...
public:
     ...
     */
    explicit AdaptiveExtendedKalmanFilter(const PredicFunc& f, const MeasureFunc& h,
