...
public:
    ...
    explicit ExtendedKalmanFilter(const PredicFunc& f, const MeasureFunc& h, const UpdateQFunc& u_q,
        ...
        // thresholds not set -> optional empty (user should set proper chi-square thresholds if
        // desired)
    ...
    const MatrixXX& getPriorCovariance() const noexcept { return P_pri; }

    const MatrixXX& getPosteriorCovariance() const noexcept { return P_post; }
